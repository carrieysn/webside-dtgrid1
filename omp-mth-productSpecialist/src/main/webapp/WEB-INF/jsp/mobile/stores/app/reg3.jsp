...
<script type="text/javascript">
	$(function(){
		$('.img-wrap .box .add').click(function(){
			...
			//showImg(_this,{doc_id: 'idxxxx', 'doc_path':'https://oss-img.meitianhui.com/communityDocs/kefu.jpg'});
		});
		
		function showImg(_this, data){
			 // 显示图片
            $(_this).parent().append(createPicDom(data.doc_path));
            // 填入图片ID
            $(_this).parent().find('.pic-id').val(data.doc_id);
            // 隐藏上传按钮
