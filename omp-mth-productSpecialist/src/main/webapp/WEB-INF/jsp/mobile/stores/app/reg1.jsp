...
<ul class="login-step top0">
	<li>
		...
		<span class="fr areaContianer">
			...
			<select class="bind-district" allow-null="true" name="area_id" datatype="*" nullmsg="请选择所在地区！"></select>
...
<script type="text/javascript">
	$(function(){
		...
		$('.areaContianer .bind-district').bind('change', function(){
			var area_code = $(this).find('option:selected').attr('area_code');
			$(this).next('[name="area_code"]').val(area_code);
		});
	});
</script>
