...
<%request.setAttribute("title", "网络集市");%>
	...
	<header>
		<div class="head">
			...
			<form action="${ctx}/mobile/goods/find?token=${token}">
				<label class="search left-search"><input id="search_input" type="search" name="keyword" placeholder="请输入关键字" value="${keyword}"></label>
			</form>
		</div>
	</header><!-- /header -->
	<div class="head-fixed">
		<a href="${ctx}/mobile/user/center?token=${token}" class="cart cart-right"></a>
	</div>
	<div class="device top-40">
